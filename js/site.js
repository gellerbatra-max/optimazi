...
(function(){
  ...
  navmenu.addEventListener("mousemove", function(e){ mTgtY=(innerHeight/2 - e.clientY)*0.13; });
  ...
  function mDraw(ts){ if(!mrun) return; var DPR=Math.min(2,window.devicePixelRatio||1),W=innerWidth,H=innerHeight;
    ...
    if(colA){ mCurY+=(mTgtY-mCurY)*0.06; colA.style.transform="translate3d(0,"+mCurY.toFixed(2)+"px,0)"; colB.style.transform="translate3d(0,"+(-mCurY).toFixed(2)+"px,0)"; }
